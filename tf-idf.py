# -*- coding: utf-8 -*-
"""
Created on Tue Jan  9 13:42:51 2018
...
path = 'C:/Users/valen/OneDrive/Documents/projet/target_press_article' 
df = import_data(path) 
...
tableau = graphlab.SFrame(df['body'])
...
sklearn_representation = sklearn_tfidf.fit_transform(df['body'])
print(sklearn_representation)

sklearn_representation.dot()
df['body'][23798]
df['theme'][23798]
len(sklearn_representation)